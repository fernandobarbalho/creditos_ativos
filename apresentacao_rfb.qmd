...
-   Por outro lado, observamos que o maior valor alcançado na série foi de R\$ 309,64 bilhões em maio de 2023.
...
-   **Sazonalidade:** A comportamento da sazonalidade acompanha o que foi observado na curva de quantidade, ou seja: valores elevados no primeiro trimestre de cada ano, seguida de uma marcante redução nos valores principalmente no segundo semestre nos anos observados.
...
-   As categorias destacadas na base de dados em uma visão geral, apresentam médias de tempos de de julgamento bastante inferiores ao que observa-se no conjunto de todos os processos

-   As medidas cautelares ou arroalmento de bens apresentam méidas de tempos de julgamento abaixo do que é aferido no cojunto de todos os processos mas se manifesta de forma superior a quase todas as outras categorias, com exceção dos programas OEA e CONFIA
